...
//var_dump($id_ruta);exit();

$rutasActual = $db->select('*')->from('gon_rutas')->where('id_ruta',$id_ruta)->fetch_first();
        ...
        <div class="col-sm-9 hidden-xs">
            <form method="post" class="form-horizontal">
                <div class="row">
                        ...
                        <div class="col-12">
                            <input type="text" name="nombre" id="nombre" class="form-control" value="<?=$rutasActual['nombre']; ?>"/>
                        ...
                        <div class="col-12">
                            <input type="text" name="descripcion" id="descripcion" class="form-control" value="<?=$rutasActual['descripcion']; ?>"/> 
                        </div>
                        <div class="col-12" >
                            <input type="hidden" name="id_ruta" id="id_ruta" value="<?=$rutasActual['id_ruta']; ?>"/>
...
/*    var lime1Icon = new LeafIcon({iconUrl: '<?= files .'/puntero/lime1.png' ?>'}),
    ...
    var coord = '<?=$t_clientes?>';//$('#cliente').val();
    //var emp = $('#empresa').val();
...
/*    console.log(porciones2);
    ...
    $(function () {
        ...
        $("#coord tbody tr").each(function (i) {
            ...
            L.polygon($rutas1).addTo(map).bindPopup(ruta[0]).setStyle({fillColor: '#000000', color: '#929292'});

        });
		//actual
	 var coord ='<?= $rutasActual['coordenadas'] ?>';
	...
	//L.polygon(puntArea).addTo(map).bindPopup('Area actual');
 	L.polygon(puntArea).addTo(map).bindPopup('Area actual').setStyle({fillColor: '#ff00ac', color: '#ff00ac'});
 
		
    measure.polygonBaseTool.startMeasure([-16.522802381401263,-68.1929218378215]);
/*
...
//debugger;
                if(validaForm()){
                    ...
                    $.ajax({ //datos que se envian a traves de ajax
                        ...
                        data:   {'wayt': wayt, 'nombre':aa, 'descripcion':dd,id_ruta:id_ruta}
                    }).done(function (ruta) {
                        if (ruta=='1') {
