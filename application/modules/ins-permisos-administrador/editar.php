...
<div class="form-group col-md-6">
          ...
          <div class="controls">
            <input id="fecha_final" onblur="DateCheck()"  name="fecha_final" type="date" class="form-control" data-validation="required date" data-validation-format="<?= $formato_textual; ?>">
          </div>
        </div>
...
<div class="form-group col">
          ...
          <textarea onclick="DateCheck()" name="motivo" id="motivo" class="form-control" data-validation="required letternumber" data-validation-allowing="-+/.,:;@#&'()_\n "></textarea>
        </div>
