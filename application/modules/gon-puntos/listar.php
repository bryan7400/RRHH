    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <h2 class="pageheader-title">Puntos</h2>
                <p class="pageheader-text"></p>
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="?/gon-rutas/listar" class="breadcrumb-link">Puntos</a></li>
                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Listado de puntos</a></li>
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                        <div class="text-label hidden-xs">Seleccione ruta:</div>
                        <select name="" id="" class="form-control"><option value="">Seleccione ruta..</option>
                        <?php
							foreach($rutas as $row){
								echo '<option value="'.$row['id_punto'].'">'.$row['nombre'].'</option>';
							}
							?>
                        </select>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6">
                        <div class="form-group">
                            ...
                            <span class=""><?= escape($row['nombre']); ?></span>
                        </div>
                        <div class="form-group">
                            <label class=""><b>Descripcion:</b></label>
                            <span class=""><?= escape($row['descripcion']); ?></span>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6 ">
                        <div class="form-group">
                            <label class=""><b>Puntos:</b></label>
                            <span class=""><?= escape($row['punto_id']); ?></span>
                        </div>
                        <div class="form-group">
                            <label class=""><b>Estado:</b></label>
                            <span class=""><?php if($row['estado'] == 1){echo 'ACTIVO';}else{echo 'INACTIVO';} ?></span>
                        </div>
<!--                        <div class="form-group">-->
							 ...
							 $nro=0;
                                ...
                                <tr class="vertr" onclick="ver_rutaactual(<?=$punto['latitud'];?>,<?=$punto['longitud']?>,this)" >
                                  ...
                                  <!--  <td class="coordenadas">-->
                                    ...
                                    <?= ($punto['nombre_lugar']); ?>
<!--                                        <span class="latitud invisible">--><?//= $punto['latitud']; ?><!--</span>-->
<!--                                        <span class="longitud invisible">--><?//= $punto['longitud']; ?><!--</span>-->
<!--                                        <span class="numero invisible">--><?//= $nro+1; ?><!--</span>-->
<!--                                        <span class="nombre invisible">--><?//= $punto['nombre_lugar']; ?><!--</span>-->
                                    </td>
                                    <?php if ($permiso_ver || $permiso_modificar || $permiso_eliminar) : ?>
                                        <td class="text-nowrap">
                                            <?php if ($permiso_asignar) : ?>
                                                ...
                                                <div class="btn-group">
												  ...
												  <div class="dropdown-menu">
													<a class="dropdown-item" href="#">Modificar punto</a>
													<a class="dropdown-item" href="#">Eliminar punto</a> 
												  </div>
												</div> 
                                            <?php endif ?>
