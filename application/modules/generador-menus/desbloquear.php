	...
	if (isset($_POST[get_csrf()])) {
		...
		if ($productos) {
			...
			$db->insert('sys_procesos', array(
				...
				'proceso' => 'u',
				'nivel' => 'm',
				'detalle' => 'Se desbloqueó los productos con identificador número ' . implode(', ', $id_productos) . '.',
				'direccion' => $_location,
				'usuario_id' => $_user['id_user']
			));
		
			// Crea la notificacion
			set_notification('success', 'Modificación exitosa!', 'Los productos fueron desbloqueados satisfactoriamente.');
