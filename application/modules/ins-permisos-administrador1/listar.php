                             ...
                             <div class="input-group">
                                <div class="input-group-append be-addon" >
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <div class="dropdown-divider"></div>
                                        <a href="?/ins-permisos-administrador/imprimir" class="dropdown-item" target="_blank"><span class="glyphicon glyphicon-print"></span> Imprimir Permiso</a>
                                        <?php endif ?> 
                                        <?php if ($permiso_imprimir) : ?>
                                        <div class="dropdown-divider"></div>
                                        <a href="?/ins-permisos-administrador/excel" class="dropdown-item" target="_blank"><span class="glyphicon glyphicon-print"></span> Excel de Permiso</a>
                                        <?php endif ?>
...

{
        "render": function (data, type, row) {
            ...
            result+="<?php if (false) : ?><a href='#' class='btn btn-info btn-xs' onclick = 'ver("+'"'+contenido+'"'+")'><span class='icon-eye'></span></a><?php endif ?> &nbsp"+
                    ...
                    "<?php if ($permiso_editar) : ?><a href='#' class='btn btn-success btn-xs' style='color:black' onclick='aprobar("+'"'+contenido+'"'+")'>Aprobar <span class='fas fa-check-circle' style='color:black'></span></a><?php endif ?>" +
                    "<?php if ($permiso_editar) : ?><a href='#' class='btn btn-danger    btn-xs' style='color:BLACK' onclick='rechazar("+'"'+contenido+'"'+")'>Rechazar <span class='fas fa-times-circle' ></span></a><?php endif ?> </BR></BR>" +
        ...
        success: function(resp){
            ...
            switch(resp){
                case '1': $("#modal_aprobar").modal("hide");
                            dataTable.ajax.reload();
                            alertify.success('Se Aprobo el Permiso correctamente');break;
