...
$permisos = $db->query("SELECT asi.*, ca.cargo, e.*, p.*
                        FROM sys_persona e 
...
// Verifica si existen los parametros
	...
	$tabla .= '<th width="18%"><B>Materias </B></th>';
	$tabla .= '<th width="12%"><B>Horarios</B></th>';
	$tabla .= '<th width="7%"><B>Motivo</B></th>';
	$tabla .= '<th width="10%"><B>Seguimiento</B></th>';
	$tabla .= '<th width="10%"><B>Inicia</B></th>';
	$tabla .= '<th width="10%"><B>Finaliza</B></th>';
