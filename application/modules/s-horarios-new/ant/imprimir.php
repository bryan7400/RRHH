...
if ($id_profesor_materia == 0) {
	...
	$pdf->Cell(0, 15, 'A PROFESOR MATERIA', 0, true, 'C', false, '', 0, false, 'T', 'M');
	...
	$tabla .= '<th width="6%">Id profesor materia</th>';
	$tabla .= '<th width="16.68%">Id profesor</th>';
	$tabla .= '<th width="22.74%">Codigo profesor</th>';
	$tabla .= '<th width="22.74%">Nombre profesor</th>';
	$tabla .= '<th width="10.61%">Materia</th>';
	$tabla .= '<th width="21.23%">Nombre materia</th>';
	$tabla .= '</tr>';
	$tabla .= $body;
	$tabla .= '</table>';
