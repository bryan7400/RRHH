    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><span id="titulo_gestion"></span> Asignar Horario Profesor </h5>
        ...
        <div class="modal-body">
          ...
          <div class="control-group margen">
            <label class="control-label">Seleccione Dia: </label>
            <div class="controls">
              <!--input id="id_asignatura" name="id_asignatura" type="text" class="form-control"-->
              <select name="id_dia_clase" id="id_dia_clase" class="form-control">
                <option value="">Buscar</option>
          ...
          <div class="control-group margen">
            <label class="control-label">Seleccione Horario: </label>
            <div class="controls">
              <!--input id="id_asignatura" name="id_asignatura" type="text" class="form-control"-->
              <select name="id_hora_clase" id="id_hora_clase" class="form-control">
                <option value="">Buscar</option>
                <?php foreach ($hora_dias as $hora_dia) { ?>
                  <option value="<?= escape($hora_dia['id_horario_dia']); ?>"><?= escape($hora_dia['hora_ini'])." -- ".escape($hora_dia['hora_fin']); ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
...
<script>
  $("#form_gestion").validate({
    ...
    messages: {
      ...
      id_dia_clase: "Debe seleccionar el dia de clases.",
      id_hora_clase: "Debe seleccionar la hora."
    },
        ...
        success: function(resp) {
          ...
          switch (resp) {
            ...
            case '2':
              ...
              alertify.success('Se asigno correctamente  el Horario al profesor');
              break;
            case '1':
              dataTable.ajax.reload();
              $("#modal_gestion").modal("hide");
