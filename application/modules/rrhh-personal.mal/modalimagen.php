...
$id_persona = (isset($_params[0])) ? $_params[0] : 0;
...
$personal = $db->select('a.*')->from('sys_persona a')->where('id_persona', $id_persona)->fetch_first();
...
//Obtenemos los niveles seleccionados por personal
...
<div class="row">
  ...
  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="btn-group">
              <div class="input-group">
                <div class="input-group-append be-addon">
                  <a href="?/rrhh-personal/listar"><button type="button" data-toggle="" class="btn btn-primary ">Regresar</button></a>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="list-group" id="result">
                    <img src="<?= ($personal['foto'] == '') ? 'files/logos/logo-defecto-institucion.png' : 'files/'.$nombre_dominio.'/profiles/personal/' . $personal['foto'] . '.jpg'; ?>" id="avatar" name="avatar" class="" style="width:auto; height:300px;">
                  </div>
                  <br>
                  <div class="list-group">
                    <label class="list-group-item text-ellipsis" style="background-color: #91d521 ;">
                      Subir Imagen
    ...
    <script>
        ...
        document.getElementById('crop').addEventListener('click', function() {
          ...
          if (cropper) {
            ...
            canvas.toBlob(function(blob) {
              ...
              $.ajax('?/rrhh-personal/subir', {
                method: 'POST',
                data: formData,
                processData: false, //es importante que este el false
                contentType: false, //es importante que este el false
                success: function(respuesta) {
                  avatar.src = "files/"+nombre_dominio+"/profiles/personal/" + respuesta; //carga la imagen recortada al elemento avatar
                  $("#avatar").val(respuesta);
                  actualizarImagenPersonal(respuesta);
      ...
      function actualizarImagenPersonal(foto) {
        var id_persona = document.getElementById('id_persona'); //id_persona
        //console.log("Hola Maretial"+id_persona.value);  
        $.post({
          url: '?/rrhh-personal/guardar-img',
          type: 'POST',
          data: {
            'accion': 'editarImagen',
          ...
          success: function(resp) {
            ...
            switch (resp) {
              case 1:
                alertify.success('Se modifico la imagen de la personal');
                break;
              case 2:
                alertify.error('Error al cargar la imagen de la personal');
                break;
            }
