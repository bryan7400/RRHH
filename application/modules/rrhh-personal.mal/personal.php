...
<?php 
if ($empleado["foto"] == ""){ ?>                                            
            <img src="files/'.$nombre_dominio.'/logos/chico.png" class='img-rounded cursor-pointer' data-toggle='modal' data-target='#modal_mostrar' data-modal-size='modal-md' data-modal-title='Imagen' width='64' height='64'>
        <?php }else{ ?>                                            
            <img src="files/'.$nombre_dominio.'/logos/<?= $empleado["foto"]; ?> " class='img-rounded cursor-pointer' data-toggle='modal' data-target='#modal_mostrar' data-modal-size='modal-md' data-modal-title='Imagen' width='64' height='64'>
        <?php } ?>
...
if (($currentDate >= $startDate) && ($currentDate <= $endDate)){ ?>                                            
    ...
    <?php } ?>
                                ...
                                <td>
                                    ...
                                    <a href="#" class="btn btn-success btn-xs" onclick="abrir_horario('<?php echo $datos ?>');"><span class="fa fa-clock"></span></a>
                    
                                    <a href="?/rrhh-personal/listar-contrato/<?= $id_asignacion; ?>" 
                                        target="_blank" data-toggle="tooltip"  data-title="Editar Contrato"  class="btn btn-info btn-xs"><span class="fa fa-file"></span></a>
                    
                                    <a href="#" data-toggle="tooltip" data-title="Eliminar horario" data-eliminar="true" class="btn btn-danger btn-xs" onclick="abrir_eliminar('<?= $id_asignacion; ?>');"><span class="fa fa-trash-alt"></span></a>
                                </td>
                                </tr>
                            <?php } ?>
...
function abrir_eliminar(nro){
    alertify.confirm('<span style="color:red">ELIMINAR PERSONAL</span>','Debe estar con autorizacion de para esta accion, si lo tiene ¿desea eliminar?',
        function(){
        $.ajax({
        url: rutaproceso,
        type: 'POST',
