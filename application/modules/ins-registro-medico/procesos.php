...
if (is_post()) {
   ...
   if($accion == "recuperar_datos"){
        $id_externo = $_POST['id_medico_estudiante'];
        $cliente = $db->query("SELECT * FROM ins_registro_medico_estudiante WHERE id_medico_estudiante='$id_externo'")->fetch_first(); 
       

        echo json_encode($cliente); 
    }

    if($accion == "listar_registros"){
