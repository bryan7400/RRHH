...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Registro Medico</h2>
                         ...
                         <div class="input-group">
                            <div class="input-group-append be-addon" >
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="#" onclick="abrir_crear();" class="dropdown-item">Crear Registro</a>
                                     
                                    <?php endif ?>  
                                    <?php if ($permiso_imprimir) : ?>
                                    <div class="dropdown-divider"></div>
                                    <a href="?/rrhh-contratos/imprimir" class="dropdown-item" target="_blank"><span class="glyphicon glyphicon-print"></span> Imprimir Registros</a>
                                    <?php endif ?> 
...
function abrir_crear(){
    ...
    $("#estudiante_id")[0].selectize.clear();  
    $('#table1').hide();  
    $("#form_estudiante")[0].reset();
    $("#dv_estatura ").hide();
    $("#dv_alergia ").hide();
