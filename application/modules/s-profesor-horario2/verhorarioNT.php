                             ...
                             <div class="btn-group">
								...
								<div class="input-group-append be-addon">
									...
									<div class="dropdown-menu">
										...
										<?php //if ($permiso_crear) : ?>
										<div class="dropdown-divider"></div>
										<a href="?/s-profesor-horario/crear" class="dropdown-item">Ver por lista de cursos</a>
                            ...
                            success: function(data){
                               ...
                               //recorrer el data con valores de un horario
                                for (var i = 0; i < data.length; i++) {
                                    ...
                                    var doc_curso='';
                                    if(data[i]["nombre_completo"]==null){
                                         doc_curso= '<br><b class="miniletra" style="color:red">('+'SIN DOCENTE ASIGNADO'+' -'+data[i]["nombre_aula"]+' '+data[i]["nombre_paralelo"]+')</b>';
                                        }else{
                                        doc_curso= '<br>(<b class="miniletra">'+data[i]["nombre_completo"]+' -'+data[i]["nombre_aula"]+' '+data[i]["nombre_paralelo"]+'</b>)';
                                        //conuslta1 sin doc id 0 
                                      

                                    }
                                    //:::::::::::::::::::::
                                    var btnEdit="<button class='btn btn-info btn-xs' ONCLICK='abrir_editar("+'"'+data[i]["id_horario_profesor_materia"]+'*'+data[i]["curso_paralelo_id"]+'*'+data[i]["profesor_id"]+'*'+data[i]["materia_id"]+'*'+data[i]["horario_dia_id"]+'*'+data[i]["dia_semana_id"]+'"'+")'><span class='icon-pencil'></span></button>"; 
                                   ...
                                   console.log('        6-FOR-'+i+'-'+data[i]["hora_ini"]+data[i]["nombre_materia"]+data[i]["dia_semana_id"]);
                                    ...
                                    horaini='<td>'+data[i]["hora_ini"]+' - '+data[i]["hora_fin"]+'</td>';
                                 //signar materia(s)   
                               ...
                               if(lunes=='')
                                ...
                                //horaini='<td>'+response[j]["hora_ini"]+'</td>';
                                 //$('#Tabla_paralelos').find('tbody').append('<tr><td>'+cc+'</td><td>'+respuesta[j]["hora_ini"]+'</td><td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'</tr>'); 
                                cc++;
