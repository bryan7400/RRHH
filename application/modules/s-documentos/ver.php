...
$materia = $db->select('a.*')->from('ins_tipo_documentos a')->where('id_tipo_documento', $id_materia)->fetch_first();
		...
		<div class="card">
			...
			<div class="card-header">
				<div class="row">
					...
					<a href="?/s-materia/listar" class="btn btn-primary">Página Anterior</a>
						<div class="btn-group">
							...
							<div class="row">
								<div class="col-12">
									...
									<!--<div class="list-group" id="result">-->
										...
										<!--<img src="<?//= ($materia['imagen_materia'] == '') ? 'assets/imgs/avatar.jpg' : 'files/profiles/materias/' . $materia['imagen_materia'] . '.jpg'; ?>" id="avatar" name="avatar" class="" style="width:auto; height:300px;">
									</div>-->
						...
						<div class="tab-regular">
							...
							<div class="tab-content" id="myTabContent7">
								...
								<div class="tab-pane fade show active" id="home-justify" role="tabpanel" aria-labelledby="home-tab-justify">
									<p class="lead"><strong>Información del documento</strong></p>
									<hr>
									<div class="table-display">
										...
										<table class="table table-striped">
											<tr>
												...
												<td>
													<div class="td"><?= escape($materia['nombre']); ?></div>
												</td>
											</tr>
											<tr>
												<th>
