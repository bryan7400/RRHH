...
//:::::::::::::::datos de retorno:::::::::::::::::::::::::::::::::::
			...
			FROM ins_inscripcion ins
				...
				WHERE  ins.gestion_id=$id_gest AND ins.estado='A'
			...
			$respuesta = array ("estado" =>"s","puntosEst"=>$puntosRe);
