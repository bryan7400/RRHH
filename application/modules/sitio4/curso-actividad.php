...
AND aa.aula_paralelo_id = $id_aula_paralelo")->fetch_first();
                            ...
                            <div class="input-group">
                                <div class="input-group-append be-addon">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="?/sitio/principal" class="dropdown-item">Lista de Cursos</a>
                                    </div>
                                </div>
                            </div>
                        </div> 
                                ...
                                <table id="table" class="table table-bordered table-condensed table-striped table-hover">
                                    <thead>
                                        <tr class="active">
                                            ...
                                            <th class="text-nowrap">Fecha<br>presentación</th>
                                    ...
                                    <tfoot>
                                        <tr class="active">
                                            ...
                                            <th class="text-nowrap text-middle" data-datafilter-filter="false">Fecha<br>presentación</th>
                                            <th class="text-nowrap text-middle">Actividad</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php $urls = explode("@", $value['url_actividad']);?>
                                        <tr>
                                            ...
                                            <td class="text-nowrap text-middle"><a href="files/documentos/<?= $value['archivo']; ?>"><i class="fas fa-download text-danger"> Descargar</i></a></td>
                                            <?php else: ?>
                                            <td class="text-nowrap text-middle"><i>Sin Archivo</i></td>
                                            <?php endif ?>
                                            <?php if ($value['url_actividad']!='') : ?>
                                                <td class="text-nowrap text-middle">
                                                <?php foreach ($urls as $i) : ?>
                                                    <a href="<?= $i; ?>" target="_blank"><i class="fas fa-link text-primary"> <?= $i; ?></i></a><br>
                                                <?php endforeach ?>
                                                </td>
                                            <?php else: ?>
                                            <td class="text-nowrap text-middle"><i>Sin url</i></td>
                                            <?php endif ?>
