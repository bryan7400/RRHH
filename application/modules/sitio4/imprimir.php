...
// Verifica si existen los parametros
	...
	$body .= '<tr>';
	$body .= '<th width="25%" align="left"><br><br><b>Fecha de Nacimiento:</b> '.$rss2.'<br> </th>';
	...
	$body .= '<tr>';
	$body .= '<th width="25%" align="left"><br><br><b>Dirección C/Av.:</b> '.$rss2.'<br> </th>';
	...
	$body .= '<th width="50%" align="left"><br><br><b>Fecha de Nacimiento:</b> '.$rss2.'<br> </th>';
	$body .= '</tr>';
...
/********************************************************************/
	...
	$body .= '<th width="50%" align="left"><br><br><b>Fecha:</b> '.$res['pastor'].'<br> </th>';
	$body .= '</tr>';
	$body .= '<tr>';
