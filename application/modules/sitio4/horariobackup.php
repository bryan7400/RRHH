...
foreach ($inscritos as $nro => $inscrito){
	...
	if ($inscrito['dia_semana_id'] == 2){
			...
			array_push($array_martes, $inscritos_nombres);
...
foreach ($inscritos as $nro => $inscrito){
	...
	if ($inscrito['dia_semana_id'] == 3){
			...
			array_push($array_miercoles, $inscritos_nombres);
...
foreach ($inscritos as $nro => $inscrito){
	...
	if ($inscrito['dia_semana_id'] == 4){
			...
			array_push($array_jueves, $inscritos_nombres);
...
foreach ($inscritos as $nro => $inscrito){
	...
	if ($inscrito['dia_semana_id'] == 5){
			...
			array_push($array_viernes, $inscritos_nombres);
...
foreach ($inscritos as $nro => $inscrito){
	...
	if ($inscrito['dia_semana_id'] == 6){
			...
			array_push($array_sabado, $inscritos_nombres);
...
$agenda2 = array(
				'Dia' => "Martes",
				'Actividad' => $array_martes					
			);

$agenda3 = array(
				'Dia' => "Miercoles",
				'Actividad' => $array_miercoles					
			);


$agenda4 = array(
				'Dia' => "Jueves",
				'Actividad' => $array_jueves					
			);

$agenda5 = array(
				'Dia' => "Viernes",
				'Actividad' => $array_viernes					
			);
	
$agenda6 = array(
				'Dia' => "Sabado",
				'Actividad' => $array_sabado					
			);
...
$array_final = array();	
array_push($array_final, $agenda, $agenda2, $agenda3, $agenda4, $agenda5, $agenda6);
