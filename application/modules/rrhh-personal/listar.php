...
$fecha_inicio_filtro = (isset($_params[0])) ? $_params[0] : "";

$fecha_final_filtro = (isset($_params[1])) ? $_params[1] : "";
...
$empleados = $db->query("SELECT asi.*, ca.cargo, e.*, p.*,p.celular AS celu , e.celular AS celulars ,p.email AS correo , e.email AS emails
        FROM sys_persona e 
...
if($currentDate < $empleado["fecha_inicio"] || $empleado["fecha_inicio"] == "0000-00-00" && $empleado["fecha_final"] == "0000-00-00"){ ?>  
...
if (($currentDate >= $startDate) && ($currentDate <= $endDate)){ ?>                                            
    ...
    <?php } ?>
                                ...
                                <td>
                                    ...
                                    <a href="?/rrhh-personal/listar-contrato/<?= $id_asignacion; ?>"  target="_blank" data-toggle="tooltip" data-title="Editar Contrato" class="btn btn-info btn-xs"><span class="fa fa-file" target="_blank"></span></a>
