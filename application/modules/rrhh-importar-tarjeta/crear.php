		...
		<div class="col-sm-8 col-sm-offset-2">
			<form method="post" action="?/empleados/guardar" class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" value="" name="codigo" id="codigo" class="form-control" autofocus="autofocus" data-validation="required server" data-validation-allowing=" " data-validation-length="max100" data-validation-url="?/empleados/verificar_codigo">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" value="" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control" autocomplete="off" data-validation-optional="true">
					</div>
				</div>
				<div class="form-group">
