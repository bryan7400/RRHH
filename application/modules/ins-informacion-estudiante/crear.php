...
$id_estudiante_codigo = (isset($_params[1])) ? $_params[1] : 0;
$datos_estudiante_ant = $db->query("SELECT * FROM ins_datos_estudiante d WHERE estado = 'A' AND id_datos_estudiante=" . $id_estudiante_codigo)->fetch();
//var_dump($datos_estudiante_ant);exit();
$datos_estudiante_ant = $db->query("SELECT COUNT(*) AS nro_estudiantes, e.curso
                    FROM ins_datos_estudiante AS de
                    INNER JOIN ins_datos_estudiante AS e ON e.curso = de.curso
                    WHERE de.id_datos_estudiante =" . $id_estudiante_codigo . " AND de.estado = 'A'")->fetch_first();
//var_dump($datos_estudiante_ant['nro_estudiantes']);exit();
...
$nivel = $db->query("SELECT * FROM ins_nivel_academico na WHERE na.gestion_id = $id_gestion AND na.estado = 'A' ORDER BY na.id_nivel_academico ")->fetch();
// Obtiene nicel académico
$tipo_estudiante = $db->query("SELECT * FROM ins_tipo_estudiante te WHERE te.gestion_id = $id_gestion AND te.estado = 'A' ORDER BY te.id_tipo_estudiante ")->fetch();
...
// Obtiene las ue de procedencia
$ue_procedencia = $db->select('*')->from('ins_inscripcion')->group_by('ue_procedencia')->fetch();
...
// Obtiene los localidad rude
$secciones = $db->select('*')->from('ins_inscripcion_rude')->group_by('seccion')->where('seccion!=', '')->fetch();

// Obtiene los localidad rudeII
$localidades_s = $db->select('*')->from('ins_inscripcion_rude')->group_by('localidad')->where('localidad!=', '')->fetch();
  ...
  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    <div class="page-header">
      ...
      <?php else : ?>
        ...
        <?php if ($id_estudiante_codigo) : ?>
          <div class="alert alert-success" role="alert">
            <h3>Numero actual de estudiantes antiguos <?= $datos_estudiante_ant['nro_estudiantes']; ?> del Curso <?= $datos_estudiante_ant['curso']; ?> </h3>
          </div>
        <?php else : ?>
    ...
    <?php if ($id_estudiante_editar) : ?>
      ...
      <?php else : ?>
        ...
        <div class="card-body">
          <form id="form_familiar">
            <div class="form-row">
                    ...
                    <div class="col-12">
                      ...
                      <div class="list-group">
                        <label class="list-group-item text-ellipsis">
                          ...
                          <input type="hidden" id="foto_tutor" name="foto_tutor" />
                        </label>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="" style="margin-top:2%">
                  ...
                  <div class="controls control-group">
                    ...
                    <select id="f_tipo_documento" name="f_tipo_documento" class="form-control" required>
                ...
                <div class="" style="margin-top:2%">
                  ...
                  <div class="controls control-group">
                    <input id="f_nit" name="f_nit" type="number" class="form-control">
                  </div>
                </div>
              </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="" style="margin-top:2%">
                  ...
                  <div class="controls control-group">
                    <input id="f_fecha_nacimiento_tutor" name="f_fecha_nacimiento_tutor" type="date" class="form-control" required>
                ...
                <div class="" style="margin-top:2%">
                  ...
                  <div class="controls control-group">
                    <input id="f_telefono" name="f_telefono" type="number" class="form-control" required>
                  </div>
                </div>
                ...
                <div class="" style="margin-top:2%">
                  ...
                  <div class="controls control-group">
                    <input id="f_nom_telefono" name="f_nom_telefono" type="text" class="form-control" onKeyUp="this.value=this.value.toUpperCase();">
                  </div>
                </div>
                <div class="" style="margin-top:2%">
            ...
            <br>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
              <button type="button" class="btn btn-info float-left" onclick="refrescarPagina()" id="btn_agregar_nuevo_familiar">Crear Nuevo Tutor</button>
              <!-- <button type="button" class="btn btn-success float-left" onclick="limpiarFormulario()">Limpiar</button> -->
              <button type="submit" class="btn btn-primary float-right" id="btn_agregar_familiar">Guardar</button>
            </div>
          </form>
          <br>
          ...
          <div id="tabla_tutores">
            <div class="card-body">
              <div class="row">
                <div class="table-responsive">
                  <table id="table_edit" class="table table-bordered table-condensed table-striped table-hover" style="width:100%">
                    <thead>
                      <tr class="active">
        ...
        <div class="tab-regular">
          ...
          <?php if ($id_estudiante_editar) : ?>
            ...
            <?php else : ?>
                ...
                <form id="form_inscripcion">
                          ...
                          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card  alert-primary-">
                              <div class="card-body">
                                ...
                                <div class="control-group">
                                  <select name="turno" id="turno" class="form-control" onchange="listar_turnos();">
                                    <option value="" selected="selected">Seleccionar</option>
                            ...
                            <div class="card  alert-primary-">
                              <div class="card-body">
                                ...
                                <ul class="social-sales list-group list-group-flush">
                                  <li class="list-group-item social-sales-content"><span class="social-sales-icon-circle facebook-bgcolor mr-2"><i class="icon-user"></i></span><span class="social-sales-name">Jovenes</span><span class="social-sales-count text-dark"><input type="text" class="form-control-plaintext" name="nro_ninos" id="nro_ninos" value=""></span>
                                  </li>
                                  <li class="list-group-item social-sales-content"><span class="social-sales-icon-circle twitter-bgcolor mr-2"><i class="icon-user-female"></i></span><span class="social-sales-name">Señoritas</span><span class="social-sales-count text-dark"><input type="text" class="form-control-plaintext" name="nro_ninas" id="nro_ninas" value=""></span>
                                  </li>
                                  <li class="list-group-item social-sales-content"><span class="social-sales-icon-circle instagram-bgcolor mr-2"><i class="icon-people"></i></span><span class="social-sales-name">Total Inscritos</span><span class="social-sales-count text-dark"><input type="text" class="form-control-plaintext" name="inscritos" id="inscritos" value=""></span>
                                  </li>
                                  <li class="list-group-item social-sales-content"><span class="social-sales-icon-circle pinterest-bgcolor mr-2"><i class="icon-layers"></i></span><span class="social-sales-name">Total cupo</span><span class="social-sales-count text-dark"><input type="text" class="form-control-plaintext" name="cupo_total" id="cupo_total" value=""></span>
                                  </li>
                                </ul>
                              </div>
                            </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      ...
                      <button type="button" id="nuevo_familiar_editar" class="btn btn-success float-left" onclick="volverInscribir()">Registrar Nuevo Familiar</button>
                      <button type="submit" class="btn btn-primary float-right" id="btn_inscripcion">Guardar</button>
                    </div>
              ...
              <?php if ($id_estudiante_editar) : ?>
                <div class="tab-pane fade show active " id="personales" role="tabpanel" aria-labelledby="personales-tab" style="background-color:#DFF2FF;">
                <?php else : ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      <div id="panel_informacion_curso_inscrito">

                        <div class="product-details">
                          <div class="border-bottom pb-3 mb-3">
                            <h2 class="mb-3"><input type="text" class="form-control-plaintext" name="curso_inscribir" id="curso_inscribir" value=""></h2>                           
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <form id="form_datos_personales">
                        <div class="form-row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                              <div class="row">
                                <div class="col-12">
                                  ...
                                  <input type="hidden" name="foto_estudiante" id="foto_estudiante">
                                  <div class="list-group">
                                    <label class="list-group-item text-ellipsis">
                                      Subir Imagen
                          ...
                          <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-6 col-xs-12">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
                              ...
                              <div class="controls control-group">
                                ...
                                <input type="hidden" id="id_estudiante_ant" name="id_estudiante_ant">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
                              ...
                              <div class="controls control-group">
                                <input id="numero_documento" name="numero_documento" type="number" class="form-control" required>
                              </div>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
                              <label class="control-label">Expedido(*): </label>
                          ...
                          <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-6 col-xs-12">
                            ...
                            <h5 class="section-title">2.6. UNIDAD EDUCATIVA DE PROCEDENCIA</h5>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
                              <div class="controls control-group">
                                <select name="ue_procedencia" id="ue_procedencia" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required>
                                  <option value="" selected="selected">Seleccionar</option>
                                  <?php foreach ($ue_procedencia as $procedencia) : ?>
                                    <option value="<?= $procedencia['ue_procedencia']; ?>"><?= escape($procedencia['ue_procedencia']); ?></option>
                                  <?php endforeach ?>
                                </select>
                              </div>
                            </div>
                            ...
                            <div>
                              <h5 class="section-title">Estado de la inscripcion</h5>
                              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
                                <div class="controls control-group">
                                  <select name="estado_inscripcion" id="estado_inscripcion" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required>
                                    <option value="INSCRITO" selected="selected">INSCRITO</option>
                            ...
                            <div id="panel_reserva">
                              <div class="" style="margin-top:2%">
                                ...
                                <div class="controls control-group">
                                  <input id="monto_reserva" name="monto_reserva" type="number" class="form-control">
                                </div>
                              </div>
                              <br>
                              <div class="" style="margin-top:2%">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
                          <label class="control-label">Observacion sobre la inscripcion</label>
                          <div class="controls control-group">
                            <textarea id="observacion" name="observacion" class="form-control" onKeyUp="this.value=this.value.toUpperCase();"></textarea>
                          </div>
                        </div>
                                    ...
                                    <form id="form_datos_certificado">
                                      <div class="form-row">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
                                          ...
                                          <div class="controls control-group">
                                            <input type="text" name="n_pais" id="n_pais" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required />
                                          </div>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
                                          ...
                                          <div class="controls control-group">
                                            <input type="text" name="n_departamento" id="n_departamento" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required />
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
                                          ...
                                          <div class="controls control-group">
                                            <input type="text" name="n_provincia" id="n_provincia" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required />
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
                                          ...
                                          <div class="controls control-group">
                                            <input type="text" name="n_localidad" id="n_localidad" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required />
                                        ...
                                        <div id="aa">
                                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
                                              <div class="controls control-group">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                  <input type="radio" id="no_disc" name="discapacidad" value="0" class="custom-control-input"><span class="custom-control-label">No</span>
                                                </label>
                                                <label class="custom-control custom-radio custom-control-inline">
                                                  <input type="radio" id="si_disc" name="discapacidad" value="1" class="custom-control-input"><span class="custom-control-label">Si</span>
                                                </label>
                                              </div>
                                            </div>
                                          </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                          <div class="" style="margin-top:2%">
                                            ...
                                            <div class="controls control-group">
                                              <input type="text" id="departamento" name="departamento" class="form-control text-uppercase" />
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                          <div class="" style="margin-top:2%">
                                            ...
                                            <div class="controls control-group">
                                              <input type="text" id="provincia" name="provincia" class="form-control text-uppercase" />
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                          <div class="" style="margin-top:2%">
                                            ...
                                            <div class="controls control-group">
                                              <input type="text" name="seccion" id="seccion" class="form-control text-uppercase" required />
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                          <div class="" style="margin-top:2%">
                                            ...
                                            <div class="controls control-group">
                                              <input type="text" id="localidad" name="localidad" class="form-control text-uppercase" required />
                                            </div>
                                          ...
                                          <div class="form-row">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                              <div class="">
                                                ...
                                                <div class="controls control-group">
                                                  <input type="text" name="a" id="a" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required />
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                  <div class="">
                                                    <input id="b1" name="b1" type="text" class="form-control" onKeyUp="this.value=this.value.toUpperCase();" placeholder="1er Idioma">
                                                  </div>
                                                </div>
                                                <br>
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                  <div class="controls control-group">
                                                    <div class="controls control-group">
                                                      <input id="b2" name="b2" type="text" class="form-control" onKeyUp="this.value=this.value.toUpperCase();" placeholder="2do Idioma">
                                                    </div>
                                                  </div>
                                                </div>
                                                <br>
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                  <div class="controls control-group">
                                                    <div class="controls control-group">
                                                      <input id="b3" name="b3" type="text" class="form-control" onKeyUp="this.value=this.value.toUpperCase();" placeholder="3er Idioma">
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
                                                ...
                                                <div>
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="">
                                                      <div class="controls">
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                          <input type="radio" value="0" id="no_d" name="d" class="custom-control-input"><span class="custom-control-label">No</span>
                                                        </label>
                                            ...
                                            <div id="ccc">
                                              ...
                                              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                ...
                                                <div>
                                                  <div class="">
                                                    <div class="controls">
                                                      <label class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" value="0" id="no_f" name="f" class="custom-control-input"><span class="custom-control-label">No</span>
                                                      </label>
                                              ...
                                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                ...
                                                <div>
                                                  <div class="">
                                                    <div class="controls">
                                                      <label class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" value="0" id="no_g" name="g" class="custom-control-input"><span class="custom-control-label">No</span>
                                                      </label>
                                                ...
                                                <div>
                                                  <div class="">
                                                    <div class="controls">
                                                      <label class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" value="0" id="no_h" name="h" class="custom-control-input"><span class="custom-control-label">No</span>
                                                      </label>
                                                ...
                                                <div>
                                                  ...
                                                  <div class="">
                                                    <div class="controls">
                                                      <label class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" value="0" id="no_i" name="i" class="custom-control-input"><span class="custom-control-label">No</span>
                                                      </label>
                                                ...
                                                <div>
                                                  <div class="">
                                                    <div class="controls">
                                                      <label class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" value="0" id="no_j" name="j" class="custom-control-input"><span class="custom-control-label">No</span>
                                                      </label>
                                              ...
                                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                ...
                                                <div>
                                                  ...
                                                  <div class="">
                                                    <div class="controls">
                                                      <label class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" value="0" id="no_k" name="k" class="custom-control-input"><span class="custom-control-label">No</span>
                                                      </label>
                                                ...
                                                <div class="">
                                                  <div class="controls">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                      <input type="radio" value="1" id="l_1" name="l" class="custom-control-input"><span class="custom-control-label">Propia</span>
                                                    </label><br>
                                              ...
                                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                ...
                                                <div class="">
                                                  <div class="controls">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                      <input type="radio" value="1" id="m_1" name="m" class="custom-control-input"><span class="custom-control-label">Diariamente</span>
                                                    </label><br>
                                                ...
                                                <div class="">
                                                  <div class="controls">
                                                    ...
                                                    <label class="custom-control custom-radio custom-control-inline" id="n" name="n">
                                                      <input type="radio" value="2" id="n_2" name="n" class="custom-control-input"><span class="custom-control-label">No (Pase a 4.6)</span>
                                                    </label><br>
                                                    <label class="custom-control custom-radio custom-control-inline">
                                              ...
                                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                ...
                                                <div class="" style="margin-top:2%">
                                                  ...
                                                  <div class="controls control-group">
                                                    <input type="text" name="o" id="o" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required />
                                                ...
                                                <div class="">
                                                  <div class="controls">
                                                    ...
                                                    <label class="custom-control custom-radio custom-control-inline" id="q" name="q">
                                                      <input type="radio" value="2" id="q_2" name="q" class="custom-control-input"><span class="custom-control-label">No</span>
                                                    </label><br>
                                                    <label class="custom-control custom-radio custom-control-inline">
                                              ...
                                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div id="especies">
                                                  ...
                                                  <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="4552" name="pago[1]" value="4552">
                                              ...
                                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                ...
                                                <div class="">
                                                  <div class="controls">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                      <input type="radio" value="1" id="s_1" name="s" class="custom-control-input"><span class="custom-control-label">A pie</span>
                                                    </label><br>
                                                  ...
                                                  <div class="" style="margin-top:2%">
                                                    <div class="" style="margin-top:2%">
                                                      <label class="control-label">Especifique: </label>
                                                      <div class="controls control-group">
                                                        <input type="text" name="461" id="461" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required />
                                                      </div>
                                                    </div>
                                                  </div>
                                                </div>
                                              ...
                                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                ...
                                                <div class="">
                                                  <div class="controls">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                      <input type="radio" value="1" id="t_1" name="t" class="custom-control-input"><span class="custom-control-label">Menos de media hora</span>
                                                    </label><br>
                                                    <label class="custom-control custom-radio custom-control-inline" id="t" name="t">
                                                      <input type="radio" value="2" id="t_2" name="t" class="custom-control-input"><span class="custom-control-label">Entre media hora y una hora</span>
                                                    </label><br>
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                      <input type="radio" value="3" id="t_3" name="t" class="custom-control-input"><span class="custom-control-label">Entre una a dos horas</span>
                                                    </label><br>
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                      <input type="radio" value="4" id="t_4" name="t" class="custom-control-input"><span class="custom-control-label">Mas de 2 horas</span>
                                                    </label><br>
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div class="">
                                                <div class="controls">
                                                  ...
                                                  <label class="custom-control custom-radio custom-control-inline" id="u" name="u">
                                                    <input type="radio" value="2" id="u_2" name="u" class="custom-control-input"><span class="custom-control-label">No (Pase a la pregunta 5.1)</span>
                                                  </label><br>
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                              ...
                                              <div class="">
                                                <div class="controls">
                                                  <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" value="1" id="r_1" name="r" class="custom-control-input"><span class="custom-control-label">Padre y Madre</span>
                                                  </label><br>
                                  ...
                                  <?php foreach ($pagos as $p) : ?>
                                    ...
                                    <tr>
                                      <td class="text-nowrap text-center"><input type="checkbox" value="<?= escape($p['id_pensiones']); ?>" name="id_pensiones[]" id="id_pensiones<?= $contador; ?>">
                                        <input type="hidden" value="<?= escape($p['tipo_concepto']); ?>" name="tipo_concepto[]">
                                      </td>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          ...
                          <div class="media-body">
                            ...
                            <form id="form_recep_documentos">
                              ...
                              <div align="left">
                                <button type="button" class="btn btn-primary" id="btn_recep_documentos" onclick="listarIncribir()">Finalizar Edicion</button>
                              </div>
                            </form>
                            <!-- </div>
                                </div> -->
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          ...
                          <div class="media-body">
                            ...
                            <form id="form_vacunas">
                              ...
                              <div class="">                                
                                <button type="submit" class="btn btn-success pull-right"><span class="fas fa-capsules"> Guardar Vacunas</span></button>
                              </div>
                            </form>
                            <!-- end vacunas  -->
                          </div>
      ...
      <div class="modal fade" tabindex="-1" role="dialog" id="modal_eliminar">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-body">
              <input type="hidden" id="id_estudiante_familiar">
              <input type="hidden" id="id_familiar">
      ...
      <script>
        ...
        // Variable para el estudiante que esta siendo inscrito y generar el reporte
        var id_estudiante_generar_reporte = 0;

        var id_estudiante_editar = <?= $id_estudiante_editar; ?>;
        var id_estudiante_codigo = <?= $id_estudiante_codigo; ?>;
        ...
        $(function() {
          ...
          // $("#departamento").val('1');
          // $("#provincia").val("Murillo");
          // $('#seccion').data('selectize').setValue('EL ALTO');
          // $('#localidad').data('selectize').setValue('EL ALTO');
          ...
          if (id_estudiante_editar) {
            ...
            $("#panel_informacion_curso_inscrito").hide();
          ...
          if (id_estudiante_codigo > 0) {
            $("#id_estudiante_ant").val(id_estudiante_codigo);
            ...
            $.ajax({
              ...
              type: 'POST',
              data: {
                'id_estudiante': id_estudiante_codigo,
                'boton': 'datos_estudiante_ant'
              },
              dataType: 'JSON',
              success: function(resp) {
                ...
                var nombre_completo = resp[0]['nombre_completo'].split(',');
                var apellidos = nombre_completo[0].split(' ');
                if (nombre_completo[1] != "") {
                  $("#nombres").val(nombre_completo[1]);
                }
                if (apellidos[0] != "") {
                  $("#primer_apellido").val(apellidos[0]);
                }
                if (apellidos[1] != "") {
                  $("#segundo_apellido").val(apellidos[1]);
                }

                $("#numero_documento").val(resp[0]['codigo']);

                $("#fecha_nacimiento").val(resp[0]['fecha_nacimiento']);
                ...
                //Datos del,tutor
                var nombre_tutor = resp[0]['tutor'].split(' ');
                if (nombre_tutor[0] != "") {
                  $("#f_nombres").val(nombre_tutor[0]);
                }
                if (nombre_tutor[1] != "") {
                  $("#f_primer_apellido").val(nombre_tutor[1]);
                }
                if (nombre_tutor[2] != "") {
                  $("#f_segundo_apellido").val(nombre_tutor[2]);
                }
                if (resp[0]['telefono'] != "") {
                  $("#f_telefono").val(resp[0]['telefono']);
                }
              }
            });
          ...
          var sEstadoInscripcion = document.getElementById('estado_inscripcion');
          sEstadoInscripcion.addEventListener('change',
            function() {
              var selectedOption = this.options[sEstadoInscripcion.selectedIndex];
        ...
        function datos_estudiante(id_estudiante_editar) {
          ...
          $.ajax({
            ...
            success: function(resp) {
              ...
              $("#estado_inscripcion").val(resp['datos_personales']['estado_inscripcion']);
              $('#estado_inscripcion').prop('disabled', 'disabled');
              ...
              $('#ue_procedencia').data('selectize').setValue(resp['datos_personales']['ue_procedencia']);
              $("#observacion").val(resp['datos_personales']['observacion']);
              ...
              $("#foto_estudiante").val(resp['datos_personales']['foto']);
              var imagen = $('#avatar');
              var url;
              if (resp['datos_personales']['foto']) {
                url = 'files/'+nombre_dominio+'/profiles/estudiantes/' + resp['datos_personales']['foto'] + '.jpg';
              } else {
              ...
              // $('#n_pais').data('selectize').setValue(resp['datos_personales']['nac_pais']);
              // $('#n_departamento').data('selectize').setValue(resp['datos_personales']['nac_departamento']);
              // $('#n_provincia').data('selectize').setValue(resp['datos_personales']['nac_provincia']);
              // $('#n_localidad').data('selectize').setValue(resp['datos_personales']['nac_localidad']);

              $('#n_pais').val(resp['datos_personales']['nac_pais']);
              $('#n_departamento').val(resp['datos_personales']['nac_departamento']);
              $('#n_provincia').val(resp['datos_personales']['nac_provincia']);
              $('#n_localidad').val(resp['datos_personales']['nac_localidad']);
              ...
              $('#a').val(resp['datos_personales']['411']);

              var idiomas = resp['datos_personales']['412'].split("@");
              ...
              $('#o').val(resp['datos_personales']['4521']);
              ...
              $('#461').val(resp['datos_personales']['461a']);
              ...
              /************/
                ...
                /* Vacunas */
              if (resp['vacunas']['tuberculosis'] == 'SI') {
                $("#bcg").attr('checked', 'checked');
              }

              if (resp['vacunas']['antipolio_1'] == 'SI') {
                $("#a1").attr('checked', 'checked');
              }

              if (resp['vacunas']['antipolio_2'] == 'SI') {
                $("#a2").attr('checked', 'checked');
              }

              if (resp['vacunas']['antipolio_3'] == 'SI') {
                $("#a3").attr('checked', 'checked');
              }

              if (resp['vacunas']['pentavalente_1'] == 'SI') {
                $("#p1").attr('checked', 'checked');
              }

              if (resp['vacunas']['pentavalente_2'] == 'SI') {
                $("#p2").attr('checked', 'checked');
              }

              if (resp['vacunas']['pentavalente_3'] == 'SI') {
                $("#p3").attr('checked', 'checked');
              }

              if (resp['vacunas']['antiamarilla'] == 'SI') {
                $("#am1").attr('checked', 'checked');
              }

              if (resp['vacunas']['mmr_unica'] == 'SI') {
                $("#spr1").attr('checked', 'checked');
              }

              if (resp['vacunas']['otra'] == 'SI') {
                $("#o1").attr('checked', 'checked');
              }

              $("#observaciones_vacunas").val(resp['vacunas']['observaciones']);
            ...
            if (cropper) {
              ...
              canvas.toBlob(function(blob) {
                ...
                $.ajax('?/s-inscripciones/imagen', {
                  ...
                  contentType: false, //es importante que este el false
                  success: function(respuesta) {
                    f_avatar.src = "files/"+nombre_dominio+"/profiles/temporal/fotos/" + respuesta; //carga la imagen recortada al elemento avatar
              ...
              success: function(resp) {
                ...
                switch (resp['estado']) {
                  case 1:
                    ...
                    mostrar_curso_inscribir(id_turno, id_aula_paralelo_A, id_tipo_estudiante, id_nivel_academico)
        ...
        $("#form_datos_personales").validate({
          ...
          submitHandler: function(form) {
            if (a_id_familiar.length > 0) {
              if (id_aula_paralelo_A > 0 && id_tipo_estudiante > 0 && id_turno > 0 && id_nivel_academico > 0) {
                  ...
                  success: function(resp) {
                    ...
                    switch (resp['estado']) {
                      case 1: //dataTable.ajax.reload();      
                        ...
                        id_estudiante_generar_reporte = resp['id_estudiante'];
                        ...
                        registrarInscripcion(id_estudiante, resp['estado_reserva'], resp['monto_reserva'], resp['fecha_reserva'], resp['id_turno'], resp['ue_procedencia'], resp['observacion'], resp['estado_inscripcion']);
                ...
                if (id_estudiante_editar != 0) {
                    ...
                    success: function(resp) {
                      ...
                      switch (resp['estado']) {
                        case 1: //dataTable.ajax.reload();
                          ...
                          registrarInscripcion(id_estudiante, 0, 0, resp['fecha_reserva'], resp['id_turno'], resp['ue_procedencia'], resp['observacion'], resp['estado_inscripcion']);
                          //alertify.success('Se registro datos personales del estudiante correctamente');
                          break;
                        case 2: //dataTable.ajax.reload();
                          transicionSalir();
                        ...
                        case 4: //dataTable.ajax.reload();
                          transicionSalir();
                          alertify.warning('El estudiante fue modificado con exito');
                          $('#rep_documentos-tab').tab('show');
                          break;
                        case 5: //dataTable.ajax.reload();
                          transicionSalir();
                          alertify.notify('Datos incompletos al enviar');
                          break;
                        case 6: //dataTable.ajax.reload();
                          transicionSalir();
                          alertify.message('No se encuentra la accion');
                  ...
                  alertify.error('Error debe inscribir en un turno, nivel y curso...');
                  console.log(id_aula_paralelo_A + " - " + tipo_estudiante + " - " + id_turno + " - " + nivel_academico);
                }
              }
            } else {
        ...
        $("#form_datos_certificado").validate({
          ...
          submitHandler: function(form) {
            ...
            if ((id_estudiante * 1) > 0) {
              ...
              alertify.error('Debe inscribir a un estudiante antes de llenar el rude');
            }
          }
        })
        ...
        $("#form_datos_rude").validate({
          ...
          submitHandler: function(form) {
            ...
            if ((id_inscripcion_rude * 1) > 0) {
              ...
              alertify.error('No puede llenar RUDE sin antes inscribir');
            }
          }
        })
              ...
              success: function(resp) {
                ...
                switch (resp['estado']) {
                  ...
                  case 10: //dataTable.ajax.reload();
                    transicionSalir();
                    //$("#modal_familiar").modal("hide");
                    alertify.warning('Se añadio un nuevo familiar correctamente');
                    refrescarPagina();
                    setTimeout("location.href='?/s-inscripciones/crear/" + id_estudiante_editar + "'", 6000);
                    break;
                }
              }
            });
            ...
            success: function(data) {
              ...
              for (var i = 0; i < data.length; i++) {
                ...
                if (data[i]['foto'] == "") {
                  ...
                  foto = "files/"+nombre_dominio+"/profiles/familiares/" + data[i]['foto'] + ".jpg";
                }
            ...
            $.ajax({
              ...
              success: function(resp) {
                if (resp == 1) {
                  transicionSalir();
                  listar_familiares(id_estudiante);
                  alertify.success('Se asigno nuevo tutor');
                }
              }
            });
          } else {
            ...
            $.ajax({
              ...
              success: function(resp) {
                if (resp == 1) {
                  ...
                  alertify.warning('Dejo de ser tutor para el estudiante');
                }
              }
            });
          }
        ...
        function abrir_modificar_familiar(contenido) {
          ...
          $.ajax({
            ...
            success: function(resp) {
              ...
              $("#f_fecha_nacimiento_tutor").val(resp['fecha_nacimiento']);
              $('#f_idioma_frecuente').data('selectize').setValue(resp['idioma_frecuente']);
              $("#f_correo_electronico").val(resp['email']);
              $("#f_telefono").val(resp['telefono_oficina']);
              $("#f_nom_telefono").val(resp['nombres_telefono_oficina']);
              ...
              var imagen = $('#f_avatar');
              $("#foto_tutor").val(resp['foto']);
              var url;
              if (resp['foto']) {
                url = 'files/'+nombre_dominio+'/profiles/familiares/' + resp['foto'] + '.jpg';
              } else {
                url = 'assets/imgs/avatar.jpg';
              }
              //imagen.src = url;
        ...
        function cargar_select_curso(aula_paralelo_id, nivel_academico_id) {
          ...
          $.ajax({
            ...
            success: function(resp) {
              ...
              $("#select_curso").append('<option value="">Seleccionar</option>');
              for (var i = 0; i < resp.length; i++) {
                if (resp[i]["id_aula_paralelo"] == aula_paralelo_id) {
                  $("#select_curso").append('<option value="' + resp[i]["id_aula_paralelo"] + '" selected="selected">' + resp[i]["nombre_aula"] + ' ' + resp[i]["nombre_paralelo"] + ' - ' + resp[i]["nombre_nivel"] + '</option>');
                } else {
                  $("#select_curso").append('<option value="' + resp[i]["id_aula_paralelo"] + '">' + resp[i]["nombre_aula"] + ' ' + resp[i]["nombre_paralelo"] + ' - ' + resp[i]["nombre_nivel"] + '</option>');
                }
              }
              //console.log(resp[0]);
            }
        ...
        function mostrar_curso_inscribir(id_turno, id_aula_paralelo, id_tipo_estudiante, id_nivel_academico) {
          ...
          $.ajax({
            ...
            dataType: 'JSON',
            success: function(resp) {
              console.log("buscar_curso_inscribir");
              console.log(resp);
              switch (resp['estado']) {
                case 1:
                  transicionSalir();
                  $("#curso_inscribir").val(resp['curso']+" "+resp['nivel']+" - "+resp['turno']);                 
                  break;
                case 2:
                  transicionSalir();
                  $("#curso_inscribir").val(resp['curso']+" "+resp['nivel']+" - "+resp['turno']);                 
        ...
        function nro_varones_mujeres(id_aula_paralelo) {
          $.ajax({
            ...
            success: function(resp) {
              console.log(resp);
              $("#nro_ninos").val(resp[0]['nro_varones']);
              $("#nro_ninas").val(resp[0]['nro_mujeres']);
              $("#inscritos").val(resp[0]['inscritos']);
              $("#cupo_total").val(resp[0]['cupo_total']);
              //alertify.error('No hay vacantes en este curso y paralelo');
        ...
        function registrarInscripcion(id_estudiante, estado_reserva, monto_reserva, fecha_reserva, id_turno, ue_procedencia, observacion, estado_inscripcion) {
          mensaje = "<img src='<?= imgs; ?>/loading.gif'  class='img-responsive' style='width:140px !important; height:115px !important' alt=''/><h1>Procesando espere...</h1>";
          transicion(mensaje);
          $.ajax({
            url: '?/s-inscripciones/procesos',
            ...
            success: function(resp) {
              ...
              switch (resp['estado']) {
                case 1:
                  ...
                  if (estado_reserva == 1) {
                    console.log(estado_reserva + 'el estador reserva');
            ...
            success: function(resp) {
              ...
              switch (resp) {
                case '1':
                  ...
                  listar_familiares(id_estudiante_familiar);
                ...
                case '2':
                  ...
                  transicionSalir();
                  $("#modal_eliminar").modal("hide");
                  alertify.error('No se puede eliminar al tutor asignado');
                  break;
                case '3':
                  //dataTable.ajax.reload();
                  transicionSalir();
                  $("#modal_eliminar").modal("hide");
                  alertify.error('Datos incorrectos de envio');
                  break;
              }
            }
          })
        ...
        function volverInscribir() {
          ...
          //$("#expedido").val("");
          $('#expedido').data('selectize').setValue("");
          ...
          $('#ue_procedencia').data('selectize').setValue("");
          $("#observacion").val("");
          $("#estado_inscripcion").prop('disabled', false);
          $("#estado_inscripcion").val('INSCRITO');
          $("#panel_informacion_curso_inscrito").show();
          $("#btn_guardar_estudiante").show();
          $("#btn_reservar_guardar").hide();
          $("#panel_reserva").hide();
        ...
        function listarIncribir() {
          window.location = "?/ins-informacion-estudiante/listar"
        }
        ...
        function reporteRude() {
          ...
          if ((id_estudiante * 1) > 0) {
            ...
            alertify.error('No se puede generar rude sin antes haber inscrito');
          }
        ...
        function imprimir_reglamento(resp) {
          // console.log('holofffffffffffffffg');
          window.open('?/s-inscripciones/imprimir-reglamento/' + id_estudiante, true);
        }
        ...
        var $ue_procedencia = $('#ue_procedencia');
        $ue_procedencia.selectize({
          persist: false,
          createOnBlur: true,
          create: true,
          onInitialize: function() {
        ...
        var $n_departamento = $('#n_departamento_');
        $n_departamento.selectize({
          persist: false,
          createOnBlur: true,
          create: true,
          onInitialize: function() {
        ...
        var $n_provincia = $('#n_provincia_');
        $n_provincia.selectize({
          persist: false,
          createOnBlur: true,
          create: true,
          onInitialize: function() {
        ...
        var $n_localidad = $('#n_localidad_');
        $n_localidad.selectize({
          persist: false,
          createOnBlur: true,
          create: true,
          onInitialize: function() {
        ...
        var dataTable = $('#table_edit').DataTable({
