...
<div class="panel-heading">
	<h3 class="panel-title" data-header="true">
		...
		<strong>Crear tipo estudiante</strong>
	</h3>
</div>
		...
		<div class="col-xs-6 text-right">
			<div class="btn-group">
				...
				<ul class="dropdown-menu dropdown-menu-right">
					...
					<li><a href="?/stipoestudiante/listar"><span class="glyphicon glyphicon-list-alt"></span> Listar stipoestudiante</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
			<form method="post" action="?/stipoestudiante/guardar" autocomplete="off">
				...
				<div class="form-group">
					...
					<input type="text" value="" name="nombre_tipo_estudiante" id="nombre_tipo_estudiante" class="form-control" autofocus="autofocus" data-validation="required letternumber length" data-validation-allowing="-/.#() " data-validation-length="max50">
				</div>
				<div class="form-group">
