<?php
   // require_once("controlador_padre.php"); 
    ...
    $feriados = $db->select('z.*, g.gestion')->from('asi_dias_feriados z')->join('ins_gestion g', 'z.gestion_id=g.id_gestion')->where('z.estado','A')->order_by('z.id_dias_feriados', 'asc')->fetch();
