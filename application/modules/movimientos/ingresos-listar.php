...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Ingresos de efectivo</h2>
            <p class="pageheader-text"></p>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Caja</a></li>
                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Ingresos de efectivo</a></li>
                             ...
                             <div class="input-group">
                                <div class="input-group-append be-addon">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="?/movimientos/ingresos-crear"><span class="glyphicon glyphicon-plus"></span> Nuevo</a>
                                    </div>
                                </div>
                            </div>
                        </div> 
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-nowrap">
								...
								<a href="?/movimientos/ingresos-modificar/<?= $ingreso['id_movimiento']; ?>" data-toggle="tooltip" data-title="Modificar ingreso"><i class="glyphicon glyphicon-edit"></i></a>
								<?php endif ?>
								<?php if ($permiso_eliminar) : ?>	
								<a href="?/movimientos/ingresos-eliminar/<?= $ingreso['id_movimiento']; ?>" data-toggle="tooltip" data-title="Eliminar ingreso" data-eliminar="true"><i class="glyphicon glyphicon-trash"></i></a>
								<?php endif ?>
							</td>
							<?php endif ?>
						</tr>
...
<?php if ($permiso_cambiar) { ?>
  ...
  $.validate({
    ...
    onSuccess: function () {
      ...
      var ruta_imprimir = '?/movimientos/ingresos-listar' + inicial_fecha + final_fecha;
      // console.log('gggg');
      // $("#imprimir").attr('href', ruta_imprimir);
      // var g = $("#imprimir").attr('href');
      // console.log(g);
      window.location = '?/movimientos/ingresos-listar' + inicial_fecha + final_fecha;
    }
  });
