...
// Obtiene las ventas
$ventas = $db->query("SELECT * FROM inv_egresos e LEFT JOIN sys_empleados se ON e.empleado_id = se.id_empleado WHERE e.fecha_egreso = '$fecha' AND e.tipo='Venta' AND e.estado = 'Valido'  group by id_egreso")->fetch();
//Obtiene compras
