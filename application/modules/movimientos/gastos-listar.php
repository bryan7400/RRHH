...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Gastos de efectivo</h2>
            <p class="pageheader-text"></p>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Caja</a></li>
                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Gastos de efectivo</a></li>
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-nowrap">
									...
									<a href="?/movimientos/gastos-modificar/<?= $gasto['id_movimiento']; ?>" data-toggle="tooltip" data-title="Modificar gasto"><i class="glyphicon glyphicon-edit"></i></a>
									<?php endif ?>
									<?php if ($permiso_eliminar) : ?>	
									<a href="?/movimientos/gastos-eliminar/<?= $gasto['id_movimiento']; ?>" data-toggle="tooltip" data-title="Eliminar gasto" data-eliminar="true"><i class="glyphicon glyphicon-trash"></i></a>
									<?php endif ?>
								</td>
								<?php endif ?>
							</tr>
