...
$permiso_listar = in_array('gastos_listar', $_views);
...
$comprobante = $db->query("select ifnull(COUNT(nro_comprobante), 0) + 1 as nro_comprobante from caj_movimientos where tipo = 'g'")->fetch_first();
