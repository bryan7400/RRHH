...
$comprobante = $db->query("select ifnull(COUNT(nro_comprobante), 0) + 1 as nro_comprobante from caj_movimientos where tipo = 'i'")->fetch_first();
...
<div class="row"> 
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"> 
        <div class="page-header">
            <h2 class="pageheader-title">Crear nuevo ingreso</h2>
                        ...
                        <div class="btn-group">
                                ...
                                <div class="input-group-append be-addon">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="?/movimientos/ingresos-listar" class="dropdown-item">Listar</a>
                                        <?php endif ?>  
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card-body">
	            <div class="row">
					...
					<div class="col-sm-8 col-md-8 ">
						<form method="post" action="?/movimientos/ingresos-guardar" id="formulario" autocomplete="off">
