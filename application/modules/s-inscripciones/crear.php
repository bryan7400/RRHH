		...
		<?php if ($id_estudiante_editar) : ?>
												...
												<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
													...
													<div class="media-body">
														...
														<form id="form_recep_documentos">
															...
															<div align="left">
																<button type="button" class="btn btn-primary" id="btn_recep_documentos" onclick="listarIncribir()">Finalizar Inscripcion</button>
															</div>
														</form>
														<!-- </div>
																</div> -->
			...
			<script>
				...
				function listarIncribir() {
					window.location = "?/s-inscripciones/listar"
				}
