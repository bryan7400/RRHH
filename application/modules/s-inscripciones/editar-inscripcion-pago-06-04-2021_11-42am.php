				...
				<div class="card">
								...
								<table id="table" class="table table-bordered"> 
									<thead>
										<tr class="">
											...
											<th class="text-center">Conceto de Pago</th>
										...
										<?php if($cuotas_habilitados): ?>
											...
											<?php foreach ($cuotas_habilitados  as $key => $cuota): ?>
												...
												<tr>
													...
													<td class="text-justify"><font size="2px"><?= escape($cuota['nombre_concepto']); ?></font><small> <b class="text-primary"> CUOTA <?= escape($cuota['nro']); ?></b></small></td>
													<td class="text-justify"><font size="1px"><?= escape($cuota['descripcion']); ?></font></td>
													<td class="text-center"><font size="2px"><?= escape($cuota['fecha_final']); ?></font></td>
													<td class="text-justify"><?= escape($cuota['cuota']); ?></td>
					...
					<?php if($cuotas_habilitados): ?>
						<div class="card-footer" style="background: #fff">
							<div class="form-row text-right">
								<div class="col-md-12 mb-0">
								<a href='?/s-inscripciones/imprimir-contracto-servicio/<?=$id_estudiante?>' class='btn btn-info'>Imprimir Contrato</a>
								<a href='?/s-inscripciones/imprimir-poliza/<?=$id_estudiante?>' class='btn btn-info'>Imprimir Poliza</a>
								</div>
							</div>
						</div>
					<?php else : ?>
...
// 			} else {
// 				$("#btn_inscripcion").hide();
// 				alertify.error('Debe seleccionar un paralelo');
// 			}
// 		}
// 	});
// }
