	...
	<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
		<?php if ($id_estudiante_editar) : ?>
						...
						<div class="form-row">
							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
								...
								<div class="" style="margin-top:2%">
									...
									<div class="controls control-group">
										<input id="f_numero_documento" name="f_numero_documento" type="number" class="form-control">
									</div>
								</div>
								<div class="" style="margin-top:2%">
										...
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
											<div id="panel_informacion_curso_inscrito">
												<div class="card border-3 border-top border-top-primary">
													<div class="card-body">
														<h4 class="text-muted">
															<input type="text" class="form-control-plaintext" name="curso_inscribir" id="curso_inscribir" value="">
														</h4>
														<div class="metric-value d-inline-block">
															<h4 class="mb-1">
																<input type="text" class="form-control-plaintext" name="nivel_inscribir" id="nivel_inscribir" value="">
															</h4>
														</div>
														<div class="metric-label d-inline-block float-right text-success font-weight-bold">
															<span class="icon-circle-small icon-box-xs text-success bg-success-light"><i class="fas fa-clock"></i></span><span class="ml-1"><input type="text" class="form-control-plaintext" name="turno_inscribir" id="turno_inscribir" value=""></span>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="form-row">
													...
													<div class="col col-xl-4 col-lg-4 col-md-12 col-sm-6 col-xs-12">
														...
														<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
															...
															<div class="controls control-group">
																<input id="numero_documento" name="numero_documento" type="number" class="form-control" data-validation-url="?/s-inscripciones/validar_documento">
															</div>
														</div>
														<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
															<label class="control-label">Expedido: (*)</label>
																		...
																		<form id="form_datos_certificado">
																			<div class="form-row">
																				...
																				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
																					...
																					<div class="controls control-group">
																						<select name="n_pais" id="n_pais" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required>
																							<option value="" selected="selected">Seleccionar</option>
																				...
																				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
																					...
																					<div class="controls control-group">
																						<select name="n_departamento" id="n_departamento" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required>
																							<option value="" selected="selected">Seleccionar</option>
																				...
																				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
																					...
																					<div class="controls control-group">
																						<select name="n_provincia" id="n_provincia" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required>
																							<option value="" selected="selected">Seleccionar</option>
																				...
																				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
																					...
																					<div class="controls control-group">
																						<select name="n_localidad" id="n_localidad" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required>
																							<option value="" selected="selected">Seleccionar</option>
																				...
																				<div id="aaa">
																					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
																						...
																						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-bottom: 4%;">
																							<div class="controls control-group">
																								<label class="custom-control custom-radio custom-control-inline">
																									<input type="radio" id="si_disc" name="discapacidad" value="0" class="custom-control-input"><span class="custom-control-label">No</span>
																								</label>
																								<label class="custom-control custom-radio custom-control-inline">
																				...
																				<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
																					<div class="" style="margin-top:2%">
																						...
																						<div class="controls control-group">
																							<select id="departamento" name="departamento" class="form-control" onchange="listar_provincias_rude();">
																								<option value="" selected="selected">Seleccionar</option>
																								<?php foreach ($departamentoA as $value) : ?>
																									<?php if ($value['id_departamento'] == 1) : ?>
																										<option value="<?= $value['id_departamento']; ?>" selected><?= escape($value['nombre']); ?></option>
																									<?php else : ?>
																				...
																				<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
																					<div class="" style="margin-top:2%">
																						...
																						<div class="controls control-group">
																							<select name="seccion" id="seccion" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required>
																								<option value="" selected="selected">Seleccionar</option>
																								<?php foreach ($secciones as $seccion) : ?>
																									<option value="<?= $localidad['seccion']; ?>"><?= escape($localidad['seccion']); ?></option>
																								<?php endforeach ?>
																							</select>
																						</div>
																					...
																					<div class="" style="margin-top:2%">
																						...
																						<div class="controls control-group">
																							<select name="localidad" id="localidad" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " required>
																								<option value="" selected="selected">Seleccionar</option>
																								<?php foreach ($localidades_s as $localidad) : ?>
																									<option value="<?= $localidad['localidad']; ?>"><?= escape($localidad['localidad']); ?></option>
																								<?php endforeach ?>
																							</select>
																						</div>
			...
			<script>
					...
					$.ajax({
						...
						success: function(resp) {
							...
							switch (resp['estado']) {
								case 1:
									transicionSalir();
									$("#curso_inscribir").val(resp['curso']);
									$("#nivel_inscribir").val(resp['nivel']);
									$("#turno_inscribir").val(resp['turno']);
									break;
								case 2:
									transicionSalir();
									$("#curso_inscribir").val(resp['curso']);
				...
				var $n_departamento = $('#n_departamento');
