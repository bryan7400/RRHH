			...
			<div class="row">
					...
					<div class="card">
						<div class="card-body">
							<div class="d-inline-block">
								<h5 class="text-muted">TOTAL INSC./INSCRITOS <?=$_gestion['gestion']?></h5>
								<h2 class="mb-0"> <?=$nroInscritosHistorial[0]['inscritos'] ?> / <?= $nroInscritos[0]['inscritos'] ?></h2>
							</div>
				...
				<div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="card">
						<div class="card-body">
							<div class="d-inline-block">
								<h5 class="text-muted">INSCRITOS HOY</h5>
								<h2 class="mb-0"><?= $nroInsHoy[0]['inscritos_hoy'] ?></h2>
							</div>
							<div class="float-right icon-circle-medium  icon-box-lg  bg-success-light mt-1">
								<i class="fas fa-users fa-fw fa-sm text-success"></i>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="card">
						<div class="card-body">
							<div class="d-inline-block">
								<h5 class="text-muted">NUEVOS/ANTIGUOS</h5>
								<h2 class="mb-0"><?=  $nroNA[0]['nro_nuevos'] ?>/<?=  $nroNA[0]['nro_antiguos'] ?></h2>
							</div>
				...
				<div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="card">
						<div class="card-body">
							<div class="d-inline-block">
								<h5 class="text-muted">INCORPORADOS</h5>
								<h2 class="mb-0"><?= $nroIBR[0]['nro_incorporados'] ?></h2>
							</div>
				...
				<div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="card">
						<div class="card-body">
							<div class="d-inline-block">
								<h5 class="text-muted">RETIRADOS</h5>
								<h2 class="mb-0"><?= $nroIBR[0]['nro_retirados'] ?></h2>
							</div>
							<div class="float-right icon-circle-medium  icon-box-lg  bg-brand-light mt-1">
								<i class="fas fa-people-carry fa-fw fa-sm text-brand"></i>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="card">
						<div class="card-body">
							<div class="d-inline-block">
								<h5 class="text-muted">BAJAS</h5>
								<h2 class="mb-0"><?= $nroIBR[0]['nro_bajas'] ?></h2>
							</div>
						...
						<table id="table" class="table table-bordered table-condensed table-striped table-hover" style="width:100%">
							<thead>
								<tr class="active">
									...
									<th class="text-nowrap">Estado Caja</th>
		...
		"columnDefs": [{
				"render": function(data, type, row) {
					...
					if(row['estado_inscripcion'] != "BAJA" && row['estado_inscripcion'] != "RETIRADO"){						
						...
						result +=
						    ...
						    "<?php if ($permiso_ver) : ?><a href='#' class='btn btn-xs btn-outline-secondary' onclick='abrir_baja_retirar(" + '"' + contenido + '"' + ")'><span class='icon-directions'></span></a><?php endif ?> &nbsp" +
			...
			},
			{
				"render": function(data, type, row) {
				    var id_estudiante = row['id_estudiante'];
				    var resulta = "";
					resulta +="<?php if ($permiso_pago) : ?><a href='?/s-inscripciones/editar-inscripcion-pago/" + id_estudiante + "' class='btn btn-xs btn-success' style='color:white'>Pago</a><?php endif ?>";
					return resulta;
				},
				"targets": 12
			},
			...
			},
			{
				"render": function(data, type, row) {
					var caja = "";
					if (row['contador'] >= 1) {
						caja += "<span class='badge badge-success text-center'>SI</span>";
					} else {
						caja += "<span class='badge badge-danger  text-center'>NO</span>";
					}
