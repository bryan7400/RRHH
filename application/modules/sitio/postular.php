...
<form id="form_gestion" name="form_gestion" method="post" autocomplete="on">
                <input id="id_postulacion" name="id_postulacion" type="hidden" class="form-control">
        ...
        foreach ($paises as $paise) { ?>
            <option value="<?= escape($paise['id_pais']); ?>"><?= escape($paise['nombre']); ?></option>
        <?php } ?>
    </select>
                    </div>
...
<div class="col-sm-4 floatt">
                        <div  class="recpt g-recaptcha"
    data-sitekey="6LcY7rsdAAAAAEZmkW6fYCUW_X17OPfxn1109Cor">
</div> 
 </div>
                        <div class="col-sm-4 floatt">                    
                    ...
                    <div id="btn_submit" class="form-group" style="margin: 0;">
                ...
                submitHandler: function(form){ 
                    ...
                    $.ajax({
                            ...
                            success: function (data) {
                                    ...
                                    window.open('?/sitio/imprimir/'+data.replace(/[^\d]/g, ''), "_blank");
...
function listar_localidad() {
    ...
    document.getElementById("tipo_postulacion").value = resp["cargo_id"];
