...
<head><meta charset="gb18030">
    ...
    <title>Login</title>
    <link rel="icon" type="image/png" href="<?= project; ?>/<?= $_institution["icono"]; ?>">
    <!-- Bootstrap CSS -->
...
<!-- <body background="fondo.jpg" style="background-repeat: no-repeat; top: 0; left: 0; width: 100%; height: 100%"> -->
    ...
    <div class="splash-container">
        <div class="card">
            <div class="card-header text-center"><a href="#"><img class="logo-img" src="./files/<?=$_institution["nombre_dominio"]?>/logos/<?= $_institution["logo_color"]; ?>" width="200px" alt="logo"></a><span class="splash-description"><small>Por favor ingrese su información de usuario.</small></span></div>
            <div class="card-body">
    ...
    <script src="http://localhost:9000/sistema/locale.js?v=<?= $version; ?>"></script>
        <script>
        $(function () {
