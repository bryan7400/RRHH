						...
						<div class="btn-group">
								...
								<div class="input-group-append be-addon">
									...
									<div class="dropdown-menu">
										...
										<a href="?/s-curso-paralelo/imprimirexcel2005" class="dropdown-item" target="_blank"><span class="glyphicon glyphicon-print"></span> Exportar Excel 2005</a>
										<!--<a href="#" class="dropdown-item"  onclick="impresionInteligente2()"><span class="glyphicon glyphicon-print"></span> Exportar Excel 2005</a>-->
										<a href="?/s-curso-paralelo/imprimirexcel" class="dropdown-item" ><span class="glyphicon glyphicon-print"></span> Exportar Excel 2007</a>
										<?php endif ?>
									</div>
								</div>
							</div>
