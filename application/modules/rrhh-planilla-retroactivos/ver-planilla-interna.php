                    ...
                    <table id="table" class="table table-bordered table-condensed table-striped table-hover">
                        <thead>
                            <tr class="active">
                                ...
                                <th class="text-nowrap">Total<br>Ganado</th>                                
                                ...
                                <th class="text-nowrap">Total<br>Descuentos</th>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        foreach ($resuxx as $resxx) { 
                                            ...
                                            echo '<input type="text" value="'.number_format($montoX,2,'.','').'" class="bono_'.$resxx['id_concepto_pago'].'" id="bono2_'.$nro.'_'.$nrie.'" name="bono2_'.$nro.'_'.$nrie.'">';
                                            echo '</td>';
                                            $bonos+=$montoX;
                                        }
                                        ?>

                                        <td style="text-align: right;" id="bonoX_<?= $nro; ?>"><?= number_format($bonos,2,'.','') ?></td>    
                                        ...
                                        foreach ($resuxx as $resxx) { 
                                            ...
                                            echo '<input type="text" value="'.number_format($montoX,2,'.','').'" id="descuentoY_'.$nro.'_'.$nrye.'" class="bono_'.$resxx['id_concepto_pago'].'" name="descuento2_'.$nro.'_'.$nrye.'">';
                                            echo '</td>';
                                        ...
                                        //$mensualidad=$resultado['id_persona'];

                                        ?>

                                        <td style="text-align: right;">
                                            <input type="text" value="<?= number_format($mensualidad,2,'.','') ?>" name="Mensualidad_<?= $nro; ?>">
                                        </td>                                    
                                        ...
                                        <td style="text-align: right;" id="descuentoX_<?= $nro; ?>"><?= number_format($total_descuentos,2,'.','') ?></td>
