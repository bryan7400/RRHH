...
<div class="row vistacard" style="display:none">
   <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            ...
            <h2 class="pageheader-title"><button class="btn btn-info btnvolver" onclick=" volver()" style=""><span class="fa fa-angle-left "></span> Volver</button> CURSO EXTRACURRICULAR</h2>
            <p></p>
            <p class="pageheader-text"></p>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="text-center">
                                   ...
                                   <button class="fa fa-cogs fa-lg  btn btn-secundary" title="Administrar curso" onclick="administrarCurso()"></button><!--<button class=" fa fa-trash btn btn-danger"></button>-->
                                    <br>
