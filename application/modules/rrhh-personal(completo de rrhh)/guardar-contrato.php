...
if (is_post()) {
        ...
        //if(isset($_POST['cargo']) ){
            ...
            $sueldo_por_hora = (isset($_POST['sueldoxhora'])) ? clear($_POST['sueldoxhora']) : 0;
            $sueldo_total = clear($_POST['sueldo_total']);
            $horas = (isset($_POST['horas'])) ? clear($_POST['horas']) : 0;
            ...
            //echo $sueldo_por_hora."-".$sueldo_total."-".$horas;
            ...
            */
            ...
            //echo $id_contrato."f".$id_contrato."f".$id_contrato."f".$id_contrato."f".$id_contrato;

            // Instancia el gondolas
            


            if( intval($id_contrato) > 0){
                /*$res = array(
