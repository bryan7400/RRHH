		...
		<div class="col-sm-6">
				...
				<div class="table-display">
					<div class="tbody">
						...
						<div class="tr">
							...
							<div class="td"><?= date_decode($empleado['fecha_nacimiento'], $_format); ?></div>
						</div>
						<div class="tr">
						...
						<div class="tr">
							...
							<div class="td"><?= escape($empleado['ci']); ?> <?= escape($empleado['codigo']); ?></div>
						</div>
						<div class="tr">
			...
			<div class="well">
				...
				<div class="table-display">
					<div class="tbody">
						<div class="tr">
							<div class="th">Sucursal:</div>
							<div class="td"><?= escape($empleado['sucursal']); ?></div>
						</div>
						<div class="tr">
						...
						<div class="tr">
							...
							<div class="td"><?= ($empleado['fecha_contratacion'] == '0000-00-00') ? 'No asignado' : date_decode($empleado['fecha_contratacion'], $_format); ?></div>
						</div>
						<div class="tr">
							<div class="th">Fecha de retiro:</div>
							<div class="td"><?= ($empleado['fecha_finalizacion'] == '0000-00-00') ? 'No asignado' : date_decode($empleado['fecha_finalizacion'], $_format); ?></div>
						</div>
						<div class="tr">
							<div class="th">Primera asistencia:</div>
							<div class="td"><?= date_decode($empleado['alta'], $_format); ?></div>
						</div>
						<div class="tr">
							<div class="th">Última asistencia:</div>
							<div class="td"><?= date_decode($empleado['baja'], $_format); ?></div>
						</div>
						<div class="tr">
...
<div id="modal_contratar" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
		<form method="post" action="?/empleados/contratar" id="form_contratar" class="modal-content loader-wrapper" autocomplete="off">
			...
			<div class="modal-body">
				<div class="form-group">
					<label for="fecha_contrato_contratar" class="control-label">Fecha de modificación:</label>
					<input type="text" value="<?= date_decode($hoy, $_format); ?>" name="fecha_contrato" id="fecha_contrato_contratar" class="form-control" data-validation="required date" data-validation-format="<?= $formato_textual; ?>">
				</div>
				<div class="form-group">
					<label for="fecha_inicial_contratar" class="control-label">Fecha de contrato:</label>
					<input type="text" value="<?= date_decode($hoy, $_format); ?>" name="fecha_inicial" id="fecha_inicial_contratar" class="form-control" data-validation="required date" data-validation-format="<?= $formato_textual; ?>">
				</div>
				<div class="form-group">
		...
		<form method="post" action="?/empleados/retirar" id="form_retirar" class="modal-content loader-wrapper" autocomplete="off">
			...
			<div class="modal-body">
				<div class="form-group">
					...
					<input type="text" value="<?= date_decode($hoy, $_format); ?>" name="fecha_final" id="fecha_final_retirar" class="form-control" data-validation="required date" data-validation-format="<?= $formato_textual; ?>">
				</div>
				<div class="form-group">
