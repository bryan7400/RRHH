...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="<?= css; ?>/linear-icons.min.css">
        ...
        <link rel="stylesheet" href="assets/css/bootstrap-loader.min.css">
        <link rel="stylesheet" href="assets/css/bootstrap-glyphicons.min.css">
        <link rel="stylesheet" href="assets/css/linear-icons.min.css">
        <link rel="stylesheet" href="assets/css/jquery.treegrid.min.css">
        <link rel="stylesheet" href="assets/css/dataTables.bootstrap.min.css">
        <link rel="stylesheet" href="assets/css/bootstrap-structured.min.css">
        <link rel="stylesheet" href="assets/css/uniform.css">
        <!--link rel="stylesheet" href="assets/css/matrix-style.css"-->
        <link rel="stylesheet" href="<?= themes . '/' . $_theme; ?>/style.min.css">

        
        <link rel="stylesheet" href="assets/themes/personalize/styletabla.css">
        ...
        <script src="assets/js/jquery.request.min.js"></script>
...
/*  .panel-form{
    ...
    .menu{
        /*opacity: 0.8;*/
background-image: -webkit-linear-gradient(bottom, #930508 40%,#D32F2F);
background-image: -moz-linear-gradient(bottom, #930508 40%,#D32F2F);
background-image: -ms-linear-gradient(bottom, #930508 40%,#D32F2F);
background-image: -o-linear-gradient(bottom, #930508 40%,#D32F2F);
    }
    </style>
    <body>
        <?php if (environment == 'production') : ?>
        <div id="loader" class="loader-wrapper loader-wrapper-fixed menu">
        ...
        <div class="container-fluid">
            <div id="panel" class="panel panel-default panel-form" >